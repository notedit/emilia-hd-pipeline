...
_S1_GATES = [
    ...
    ("dnsmos_ovrl", "min", "min_dnsmos_ovrl"),
    ("snr_db", "min", "min_snr_db"),
    ("clipping_ratio", "max", "max_clipping_ratio"),
    ("bandwidth_hz", "min", "min_bandwidth_hz"),
]
# S1 metrics stored but not gated (kept for S5 scoring); report distribution only.
_S1_UNGATED = ["aes_ce", "aes_cu", "dnsmos_sig", "dnsmos_bak", "loudness_lufs"]
_S2_METRICS = [
